**Цей проєкт присвячений оптимізації SQL-запитів у MySQL.**
Основна мета це покращити продуктивність аналітичних запитів шляхом зменшення зайвих обчислень та оптимізації операцій JOIN.
